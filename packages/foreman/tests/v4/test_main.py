...
def test_main_help_exits_cleanly(
    ...
    # foreman#476: bootstrap now calls ensure_base_mirror for each active
    # project. Stub it so the --help smoke test doesn't attempt a real
    # git clone to a non-existent GitHub repo.
