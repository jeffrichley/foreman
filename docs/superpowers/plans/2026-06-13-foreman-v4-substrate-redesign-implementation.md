...
| 4 | **QueueManager + Poller** — `WorkItem`, `QueueManager` (Mediator, dedup, hold-respect, concurrency cap), `WorkerPool`, `Poller`, `PyGithubGitProvider` (real impl), runtime triad e2e (7 tasks) | [v4-phases/phase-4-queuemanager-poller.md](./v4-phases/2026-06-13-foreman-v4-phase-4-queuemanager-poller.md) | Poller → QM → WorkerPool drives ticket to Done. |
